  ...
  while(true) 
    {    
      ...
      // finally make it stop.
		...
		speed = 0;
		turnrate = -(M_PI/2)/(turnInterval - forwardInterval); //ties turnrate to time, i.e. 90 degrees distributed over this interval. The greater the diff the slower it turns
       		 }
